		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-4">
					...
					<h2 align="center" style="color:#9999FF">Faculty Portal</h2>
				</div>
				<div class="col-sm-4">
				</div>
			</div>
			<div class="row">
				...
				<div class="col-sm-4 well">
					...
					<form action="faculty_process.php" method="POST">
					<div class="row">
						<div class="col-sm-4">
						...
						<div class="col-sm-8">
							<input type="text" name="username" placeholder="enter username" id="username" class="form-control" required  maxlength="4" minlength="4"  size="4" pattern="[t]{1}[12]{1}[0-9]{2}" title="please give the valid teacher id">
						</div>
					</div><!--row1 ends-->
