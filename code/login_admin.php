		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-4">
					...
					<h2 align="center" style="color:#9999FF">Admin Portal</h2>
				</div>
				<div class="col-sm-4">
				</div>
			</div>
			<div class="row">
				...
				<div class="col-sm-4 well">
					...
					<div class="row">
						...
						<div class="col-sm-8">
							<input type="text" name="username" placeholder="enter username" id="username" class="form-control" required size="10" minlength="2" maxlength="10" title="username should contain maximum 10 characters">
						</div>
					</div><!--row1 ends-->
